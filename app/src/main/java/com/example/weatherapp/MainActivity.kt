...
//28dd6de805c1d5fb05907bb2a3f42d4a
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName: String) {
        ...
        val response = retrofit.getWeatherData(
            cityName,
            appid = "28dd6de805c1d5fb05907bb2a3f42d4a",
            units = "metric"
        )
    ...
    private fun changeImags(conditions: String) {
        ...
        when (conditions){
            ...
            "Light Rain", "Drizzle", "Moderate Rain", "Showers", "Heavy Rain","Rain" -> {
                ...
                binding.root.setBackgroundResource(R.drawable.rain11)
